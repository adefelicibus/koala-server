...
class ProtPredEDACEDA(object):
    ...
    def main(self):
        ...
        try:
            ...
            self.ClassColection.copyFilesToExecuteFolder(self.path_execute, 'ProtPredEDA_CEDA')
            ...
            if self.opts.createCompressFile == "True":
                if self.ClassColection.compressFiles(pdbs, self.path_execute, "ProtPredEDA-CEDA"):
                    path_output, file_output = os.path.split(self.opts.outputZip)
                    self.ClassColection.sendOutputResults(
                            path_output,
                            file_output,
                            os.path.join(self.path_execute, 'ProtPredEDA-CEDA.zip'))
