...
class ProtPredEDAMCM(object):
    ...
    def main(self):
        ...
        try:
            ...
            self.ClassColection.copyFilesToExecuteFolder(self.path_execute, 'ProtPredEDA_MCM')
            ...
            if self.opts.createCompressFile == "True":
                if self.ClassColection.compressFiles(pdbs, self.path_execute, "ProtPredEDA-MCM"):
                    path_output, file_output = os.path.split(self.opts.outputZip)
                    self.ClassColection.sendOutputResults(
                            path_output,
                            file_output,
                            os.path.join(self.path_execute, 'ProtPredEDA-MCM.zip'))
