...
class ProtPredEDAEDA(object):
    ...
    def main(self):
        ...
        try:
            ...
            # Config
            self.ClassColection.setParameter('OptimMethod', 'eda')
            ...
            self.ClassColection.setParameter('SamplingMode', self.opts.SamplingMode_EDA)
            self.ClassColection.setParameter('Noise', self.opts.Noise)
            ...
            if(self.opts.SamplingMode_EDA == "fgm"):
                ...
                self.ClassColection.setParameter('Threshold', self.opts.Threshold_EDA)
            ...
            self.ClassColection.copyFilesToExecuteFolder(self.path_execute, 'ProtPredEDA_EDA')
            ...
            if self.opts.createCompressFile == "True":
                if self.ClassColection.compressFiles(pdbs, self.path_execute, "ProtPredEDA-EDA"):
                    path_output, file_output = os.path.split(self.opts.outputZip)
                    self.ClassColection.sendOutputResults(
                            path_output,
                            file_output,
                            os.path.join(self.path_execute, 'ProtPredEDA-EDA.zip'))
