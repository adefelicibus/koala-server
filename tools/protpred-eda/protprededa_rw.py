...
class ProtPredEDARW(object):
    ...
    def __init__(self, opts=None):
        ...
        self.framework = Params('ProtPred-EDA', 'rw')
    ...
    def main(self):
        ...
        try:
            ...
            # Config
            self.framework.set_parameter('OptimMethod', 'rw')
            ...
            if(self.opts.runMinimization == 'true'):
                self.do_minimization("ProtPredEDA_RW")
            ...
            if self.opts.createCompressFile == "True":
                if compress_files(pdbs, self.path_runs.get_path_execution(), "ProtPredEDA-RW"):
                    path_output, file_output = os.path.split(self.opts.outputZip)
                    send_output_results(
                        path_output,
                        file_output,
                        os.path.join(
                            self.path_runs.get_path_execution(), 'ProtPredEDA-RW.zip'))
