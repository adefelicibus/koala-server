...
def load_parameters():
	...
	parser.add_argument("-l", action = "store", dest = "ligand", required = True) # Parameter for ligand
	parser.add_argument("-r", action = "store", dest = "receptor", required = True) # Parameter for receptor
	parser.add_argument("-b", action = "store", dest = "box", required = True) # Parameter for box of active site
	parser.add_argument("-p", action = "store", dest = "path_output", required = True) # Parameter for path output
	parser.add_argument("-f", action = "store", dest = "file_output1", required = True) # Parameter for structure file
	parser.add_argument("-g", action = "store", dest = "file_output2", required = True) # Parameter for log file
...
def main():
	...
	run_docking(autodock_vina, arguments.box, ligand_pdbqt, receptor_pdbqt, arguments.file_output1, arguments.file_output2)
