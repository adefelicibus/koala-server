...
def load_settings():
    ...
    return vina, pythonsh, script_ligand4


def check_autodock_vina(autodock_vina, pythonsh, script_ligand4):
...
def main():
    ...
    vina, pythonsh, script_ligand4 = load_settings()
    check_autodock_vina(vina, pythonsh, script_ligand4)
    check_mol2_path(path_mol2)
    convert_dat_for_mol2(arguments.ligand, path_mol2)
    mol2_file = get_mol2_file(path_mol2)
    convert_mol2_to_pdbqt(mol2_file, arguments.file_output, pythonsh, script_ligand4)
